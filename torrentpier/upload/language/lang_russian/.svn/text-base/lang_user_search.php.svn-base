...
$lang['SEARCH_FOR_USERFIELD_YAHOO'] = 'Поиск пользователей с адресом Yahoo IM %s';
$lang['SEARCH_FOR_USERFIELD_AIM'] = 'Поиск пользователей с адресом AIM %s';
$lang['SEARCH_FOR_USERFIELD_MSN'] = 'Поиск пользователей с адресом MSN Messenger %s';
