...
bool Ctracker_input::banned() const
{
        ...
        if (m_peer_id[7] == '-')
                ...
                case '-':
                        ...
                        {
                        case 'A': // -AZ* > Azureus
                                return starts_with(m_peer_id, "-AZ2303")
                        ...
                        case 'B': // -BC* > BitComet, -BB* > ?
                                return starts_with(m_peer_id, "-BB")
                                        || starts_with(m_peer_id, "-BO")
                                        || starts_with(m_peer_id, "-BC");
                        case 'U': // -UT* > uTorrent
                                return starts_with(m_peer_id, "-UT11")
                                        || starts_with(m_peer_id, "-UT11");
                        case 'T': // -TS* > TorrentStorm || -TR* > Transmission
                                return starts_with(m_peer_id, "-TS")
                                        || starts_with(m_peer_id, "-TR");
                        case 'X': // -XX* > Patched Transmission
                                return starts_with(m_peer_id, "-XX");
                        default:
                                return false;
                        }
                case 'M' :
                        return starts_with(m_peer_id, "M5")
                                // || starts_with(m_peer_id, "M5-0-1--")
                                || starts_with(m_peer_id, "M4-2-2--")
                                || starts_with(m_peer_id, "M4-24-0-")
                                || starts_with(m_peer_id, "M4-26-0-")
                                || starts_with(m_peer_id, "M4-22-1-")
                                || starts_with(m_peer_id, "M4-4-1--");
                ...
                case '-':
                        ...
                        case 'T': // -TR* > ?
                                return starts_with(m_peer_id, "-TR");
                        case 'X': // -XX* > ?
                                return starts_with(m_peer_id, "-XX");
				...
				default:
                        return starts_with(m_peer_id, "BS")
                                ...
                                // || starts_with(m_peer_id, "M4")
                                // || starts_with(m_peer_id, "M5");
                }
        return false;
